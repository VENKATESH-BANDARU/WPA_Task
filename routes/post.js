...
const { getAllPosts, singlePost, createPost, updatePost, deletePost, postSubscribe } = require('../controllers/post.controller');
...
router.post('/subscribe', authenticate, postSubscribe);
